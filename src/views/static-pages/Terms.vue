  ...
  <div class="law">
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>This website is operated by FormulaRay. Throughout the site, the
          terms <b>“we”</b>, <b>“us”</b> and
          <b>“our”</b>
          refer to
          FormulaRay. FormulaRay offers this website, including all information,
          tools and services available
          from this
          site to you, the user, conditioned upon your acceptance of all terms,
          conditions, policies and notices
          stated
          here.
        </p>
        <p>
          By visiting our site and/ or purchasing something from us, you engage
          in our “Service” and agree to be bound
          by the following terms and conditions (“Terms of Service”, “Terms”),
          including those additional terms and
          conditions and policies referenced herein and/or available by
          hyperlink. These Terms of Service apply to all
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          information), may be transferred unencrypted and
          ...
          information is always encrypted during transfer
          over networks. <br>
          You agree not to reproduce, duplicate, copy, sell, resell or exploit
          any portion of the Service, use of the
          Service, or access to the Service or any contact on the website
          through which the service is provided, without
          express written permission by us. <br>
          The headings used in this agreement are included for convenience only
          and will not limit or otherwise affect
          these Terms.
        </p>
      </div>
    </div>
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          not accurate, complete or current. The
          material on this site is provided for general information only and
          should not be relied upon or used as the
          sole basis for making decisions without consulting primary, more
          accurate, more complete or more timely
          sources of information. Any reliance on the material on this site is
          at your own risk. <br>
          This site may contain certain historical information. Historical
          information, necessarily, is not current and
          is provided for your reference only. We reserve the right to modify
          the contents of this site at any time, but
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          (or any part or content thereof) without
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          through the website. These products or
          services may have limited quantities and are subject to return or
          exchange only according to our Return
          Policy. <br>
          We have made every effort to display as accurately as possible the
          colors and images of our products that
          ...
          service made on this site is void where
          prohibited. <br>
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          or under the same customer account, the same credit card, and/or
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          neither monitor nor have any control nor
          input. <br>
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          them before you engage in any
          transaction. Complaints, claims, concerns, or questions regarding
          third-party products should be directed to
          the third-party.
        </p>
      </div>
    </div>
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          contest entries) or without a request
          from us you send creative ideas, suggestions, proposals, plans, or
          other materials, whether online, by email,
          by postal mail, or otherwise (collectively, 'comments'), you agree
          that we may, at any time, without
          restriction, edit, copy, publish, distribute, translate and otherwise
          use in any medium any comments that you
          forward to us. We are and shall be under no obligation (1) to maintain
          any comments in confidence; (2) to pay
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          information in the Service or on any
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          any obscene or immoral purpose; or (k)
          to interfere with or circumvent the security features of the Service
          or any related website, other websites,
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          non-infringement. <br>
          In no case shall FormulaRay, our directors, officers, employees,
          affiliates, agents, contractors, interns,
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          You agree to indemnify, defend and hold harmless FormulaRay and our
          parent, subsidiaries, affiliates,
          partners, officers, directors, agents, contractors, licensors, service
          providers, subcontractors, suppliers,
          ...
          Service or the documents they incorporate
          by reference, or your violation of any law or the rights of a
          third-party.
        </p>
      </div>
    </div>
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          of Service, such determination shall not
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          termination date shall survive the
          termination of this agreement for all purposes. <br>
          These Terms of Service are effective unless and until terminated by
          either you or us. You may terminate these
          Terms of Service at any time by notifying us that you no longer wish
          to use our Services, or when you cease
          using our site. <br>
          If in our sole judgment you fail, or we suspect that you have failed,
          to comply with any term or provision of
          these Terms of Service, we also may terminate this agreement at any
          time without notice and you will remain
          liable for all amounts due up to and including the date of
          termination; and/or accordingly may deny you access
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          these Terms of Service shall not constitute
          a waiver of such right or provision. <br>
          ...
          and us and govern your use of the
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          you Services shall be governed by and
    ...
    <div class="textbox">
      ...
      <div class="textbox-text">
        <p>
          ...
          replace any part of these Terms of Service
          by posting updates and changes to our website. <br>
          It is your responsibility to check our website periodically for
          changes. Your continued use of or access to
      ...
      <div class="textbox-text">
        <p>
          Questions about the Terms of Service should be sent to us at <span
            style="color:rgb(44, 113, 240)"
          >service@buykop.com</span>.
        </p>
      </div>
    </div>
  </div>
...
.law {
    @include font-n(12px, #40454a);
    border-top: 1px solid $border-color-5;
}
.title {
    @include font-b(14px, $word-color-6);
    line-height: 20px;
